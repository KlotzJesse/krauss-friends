...
const TwoColumnsWithTestimonial = (props) => {
  return (
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-start">
          ...
          <div className="mt-12 relative text-base max-w-prose mx-auto lg:mt-0 lg:max-w-none">
            ...
            <blockquote className="relative bg-white rounded-lg shadow-lg">
              ...
              <cite className="relative flex items-center sm:items-start bg-primary-600 rounded-b-lg not-italic py-5 px-6 sm:py-5 sm:pl-12 sm:pr-10 sm:mt-10">
                ...
                <span className="relative ml-4 text-primary-300 font-semibold leading-6 sm:ml-24 sm:pl-1">
