  ...
  return (
    <>
      <div className="mx-auto container px-4 xl:px-0 mt-16 lg:mt-32 f-f-p">
        <h1 className="text-center text-3xl lg:text-4xl font-bold tracking-wide text-gray-900">
          Warum Unternehmen sich für KRAUSS Training entscheiden
        </h1>
              ...
              <div>
                <div className="flex items-center justify-end pb-12 xl:pr-10">
                  ...
                  <div className="flex flex-col pl-8 xl:w-8/12">
                    <h2 className="text-base xl:text-2xl font-semibold tracking-wider text-gray-900">
                      Mobile App
                    </h2>
                    <p className="text-gray-700 leading-7 tracking-wide text-base mt-3">
